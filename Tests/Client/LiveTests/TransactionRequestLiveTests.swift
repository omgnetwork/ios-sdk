...
class TransactionRequestLiveTests: LiveClientTestCase {
    ...
    func testChannelNotFound() {
        ...
        let delegate = TestSocketEventDelegate(joinExpectation: joinExpectation)
...
extension TransactionRequestLiveTests {
    ...
    func startListeningForEvent(forTransactionRequest transactionRequest: TransactionRequest) -> TestSocketEventDelegate {
    ...
    func startListeningForEvent(forConsumption transactionConsumption: TransactionConsumption) -> TestSocketEventDelegate {
        let joinExpectation = self.expectation(description: "Join channel")
        let delegate = TestSocketEventDelegate(joinExpectation: joinExpectation)
    ...
    func waitForConsumption(withDelegate delegate: TestSocketEventDelegate) -> TransactionConsumption {
    ...
    func waitForSuccessFinalization(withDelegate delegate: TestSocketEventDelegate) -> TransactionConsumption {
        wait(for: [delegate.eventExpectation!], timeout: 15.0)
    ...
    func waitForFailedFinalization(withDelegate delegate: TestSocketEventDelegate) -> (APIError, TransactionConsumption) {
        wait(for: [delegate.eventExpectation!], timeout: 15.0)
