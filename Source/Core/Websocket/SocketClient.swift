...
/// A SocketClient needs to be initialized using either a ClientConfiguration or an AdminConfiguration.
/// It can then be used to listen to different listenable resources
/// You don't need to use any function of this class directly. Instead, you can pass this class as
/// a parameter for the different listenable resources.
