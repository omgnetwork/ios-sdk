...
/// This enum describes the diferent event that can be received from the websockets.
///
/// - reply: A reply from a previously sent message
/// - error: An error that occured
/// - close: Closure of a topic
/// - transactionConsumptionRequest: A new consumption request on a transaction request
/// - transactionConsumptionFinalized: A consumption has been finalized
/// - other: Any other unhandled event (as a string)
